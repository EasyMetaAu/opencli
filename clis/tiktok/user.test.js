...
describe('tiktok/user', () => {
    ...
    it('navigates to the profile and returns complete rows from page context', async () => {
        const rows = [{
            index: 1,
        ...
        await expect(userCommand.func(page, { username: '@dictogo', limit: 1 })).resolves.toEqual(rows);
